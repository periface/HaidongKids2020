class PlayGame extends Phaser.Scene {
    ...
    create() {
        ...
        // add player
        this.player = this.add.sprite(game.config.width * 1.5, game.config.height - 40, "player");

        // add dog
        this.dog = this.add.sprite(game.config.width * 1.5, game.config.height - 40, "dog");
    ...
    update() {
        ...
        this.bg_1.tilePositionX += .6;
        this.bg_2.tilePositionX += .8;
